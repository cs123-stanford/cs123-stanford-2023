...
+------------------+---------------------------------------------------+-------------------------------------------+------------------+
| Week 7: 11/6     | AI-enabled Quadrupeds: Computer Vision            | :doc:`../schedule/labs/fall-23/lab-7`     | 11/13            |
+------------------+---------------------------------------------------+-------------------------------------------+------------------+
| Week 8: 11/13    | AI-enabled Quadrupeds: LLMs                       | :doc:`../schedule/labs/fall-23/lab-8`     | 11/20            |
+------------------+---------------------------------------------------+-------------------------------------------+------------------+
